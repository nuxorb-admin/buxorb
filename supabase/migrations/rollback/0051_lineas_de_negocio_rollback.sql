-- =========================================================
-- ROLLBACK de 0051_lineas_de_negocio.sql y 0052_ldn_restaurant.sql — NO
-- forma parte de la secuencia normal de migraciones, no se aplica con
-- `db push`. Correr a mano en el SQL Editor de Supabase solo si se decide
-- dar marcha atrás al eje de producto "Líneas de negocio" (o solo a la
-- línea "Restaurantes", que hasta ahora es la única). Ver
-- docs/lineas-de-negocio-rollback.md para la lista de archivos de código
-- a revertir junto con esto.
-- =========================================================
